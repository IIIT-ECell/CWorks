...
class EditStudent extends Component{
    ...
    componentDidMount(){
        ...
        .then((response)=>{
            ...
            .then((response)=>{
                ...
                axios({
                    method: 'GET',
                    url: 'http://abhigyanghosh30.pythonanywhere.com/api/users/stutest/' + response.data.id,
                })
                .then((response)=>{
                    console.log(response.data);
    ...
    handleSubmit(event){
        ...
        axios({
            method:"PUT",
            url:"http://abhigyanghosh30.pythonanywhere.com/api/users/students/"+this.state.user.id+"/",
            data:{
